...
public class Utilidades {
    ...
    public static final String SITIOS_DESCRIPCION_CORTA = "descripcion_corta";
    public static final String SITIOS_DESCRIPCION_LARGA = "descripcion_larga";
